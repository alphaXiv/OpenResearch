...
% paper's figures, not with the body text.
\renewcommand{\familydefault}{\sfdefault}
% For a diagram that must instead match a Times-set body font, drop the line
% above and uncomment:
...
\tikzset{
  ...
  edgelbl/.style={font=\scriptsize, text=black!60, inner sep=1.5pt, fill=white},

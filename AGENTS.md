...
- Windows artifacts are unsigned. `docs/windows-signing.md` is the setup runbook for signing them; do not add signing config without completing it, as there is no runtime gate and an incomplete setup fails the release.

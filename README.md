...
<img src=".github/readme-assets/cursor.svg" alt="" width="16" height="16" align="texttop" /> Cursor, or
DeepSeek Harness into research agents that can review
...
| **Your choice of agent** | Use Claude Code, Codex, OpenCode, Cursor, or DeepSeek Harness, with the harness and model selected per session. |
